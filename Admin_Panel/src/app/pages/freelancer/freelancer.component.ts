...
export class FreelancerComponent implements OnInit {
  ...
  updateInfo(id: any, uid: any) {
    ...
    this.util.show();
    this.api.post_private('v1/individual/getByIdAdmin', { id: uid }).then((data: any) => {
      console.log(data);
      this.util.hide();
      if (data && data.status && data.status == 200) {
        ...
        console.log(data && data.data && data.data.commission && data.data.commission.rate && data.data.commission.rate != null);
        if (data && data.data && data.data.commission && data.data.commission.rate && data.data.commission.rate != null) {
          this.rate = data.data.commission.rate;
